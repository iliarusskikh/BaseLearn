...
contract FavoriteRecords {
    ...
    mapping(address=> uint8) public ages;//public posts value
    function register(uint8 age) external returns(bool)
    {
            //anyone can register their address.address userAddress 
        ages[msg.sender] = age;//0x5B38Da6a701c568545dCfcB03FcB875f56beddC4
        //keccak256(msg.sender,0);
        return true;
    }
